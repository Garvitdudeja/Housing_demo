import { ImageUpload, createAdmin } from "@/redux/slices/web";
...
const AddAdminModal = (props) => {
  ...
  const handleAdminAdd = (event) => {
    ...
    if (!data?.email && !data?.last_name && !data?.first_name) {
      ...
      data?.first_name[0] == " " ||
      data?.first_name.split(" ").length > 1
    ) {
  ...
  return (
    <>
      <div className="addSupervisorModal">
        <h2 className="heading24">Add New Admin</h2>
